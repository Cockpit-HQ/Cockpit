...
class Api extends App {
    ...
    public function key($id = null) {
        ...
        $key = $this->app->data->findOne('system/api_keys', ['_id' => $id]);
    ...
    public function remove() {
        ...
        $this->app->data->remove('system/api_keys', ['_id' => $key['_id']]);
    ...
    public function save() {
        ...
        $_key = $this->app->data->findOne('system/api_keys', ['key' => $key['key']]);
        ...
        $this->app->data->save('system/api_keys', $key);

        $key = $this->app->data->findOne('system/api_keys', ['_id' => $key['_id']]);
    ...
    public function load() {
        ...
        $keys = $this->app->data->find('system/api_keys', [
            'sort' => ['name' => 1]
        ])->toArray();

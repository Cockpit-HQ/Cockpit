                ...
                <li v-for="(user, idx) in users" :class="{'kiss-inactive': !user.active}">
                    ...
                    <div class="kiss-margin kiss-flex">
                        <div class="kiss-margin-right kiss-position-relative">
                            ...
                            <a class="kiss-cover" :href="$route('/settings/users/user/'+user._id)"></a>
                        </div>
                ...
                <kiss-container size="small">
                    <div class="kiss-flex kiss-flex-middle kiss-flex-right">
                        <div class="kiss-button-group">
                            ...
                            <a class="kiss-button" href="<?=$this->route('/settings/users/roles')?>"><?=t('Manage roles')?></a>
                            <?php endif ?>
                            <a class="kiss-button kiss-button-primary" href="<?=$this->route('/settings/users/create')?>"><?=t('Add user')?></a>
                        </div>
                    </div>
                </kiss-container>
            ...
            export default {
                ...
                methods: {
                    ...
                    load() {
                        ...
                        this.$request('/settings/users/load', {options:{}}).then(data => {
                    ...
                    remove(user) {
                        ...
                        App.ui.confirm('Are you sure?', () => {
                            ...
                            this.$request('/settings/users/remove', {user}).then(res => {
